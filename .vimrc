...
colorscheme desert " morning elflord darkblue    vimtax.com
...
set encoding=utf8 " Set utf8 as encoding and en_US as language
...
set noshowmode " duplicate since this is in statusline
...
autocmd BufNewFile,BufReadPost *.md set filetype=markdown " avoid Modula-2 confusion
map <C-l> :NERDTreeToggle<CR> " Toggle NERDTree
